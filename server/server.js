...
let gameState=new GameState([[{id:'pikachu', shown:true, src:'img/artifacts/Pikachu_256px.png', isBeingUsed:false}]],emitState);
gameIo.on('connection', function(socket){
  console.log('a user connected');
  
  const userId = gameState.addPlayer('gramsci', 'queer', 0)
